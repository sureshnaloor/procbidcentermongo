...
import { FileSpreadsheet, Loader2, Download, Trash2, CalendarClock, FileText, Mail, Check } from "lucide-react";
      ...
      <section className="space-y-3">
        ...
        {isLoading ? (
          ...
          <div className="space-y-4 stagger-children">
            {rows.map((row: any) => (
              <Card key={String(row.tender._id)} className="border-0 shadow-[var(--shadow-card)] card-3d">
                <CardContent className="p-5 space-y-4">
